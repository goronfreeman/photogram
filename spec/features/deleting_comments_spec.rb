...
feature 'Deleting comments' do
  background do
    ...
    comment_one = create(:comment, user_id: user_two.id, post_id: post.id, content: 'Nice post!')
    comment_two = create(:comment, id: 2, user_id: user_one.id, post_id: post.id, content: 'You guys are too kind xo')
